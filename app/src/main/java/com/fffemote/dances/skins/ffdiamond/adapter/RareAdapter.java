...
import com.fffemote.dances.skins.ffdiamond.databinding.ItemRareBinding;
...
public class RareAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RareAdapter(ArrayList<dress> contactsList, Context context, Activity mactivity) {
    ...
    public void setAds(boolean isCheck) {
        ...
        int PARTICLE_AD_DISPLAY_COUNT = 5 * 2;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ItemRareBinding binding;

        public ViewHolder(@NonNull ItemRareBinding itemView) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        if (i == VIEW_AD)
            ...
            return new ViewHolder(ItemRareBinding.inflate(LayoutInflater.from(mactivity), parent, false));
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof AdHolder) {
            ...
            holder1.binding.rIcon.setImageResource(contactsList.get(position).getdIcon());
            holder1.binding.rText.setText(contactsList.get(position).getdName());

            holder1.binding.rMain.setOnClickListener(new View.OnClickListener() {
                @Override
