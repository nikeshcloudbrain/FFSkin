...
public class CTCModelAd {
    ...
    @SerializedName("ads_applovin_banner_id")
    @Expose
    private String adsApplovinBannerId = "";
    @SerializedName("ads_applovin_inter_id")
    @Expose
    private String adsApplovinInterId = "";
    @SerializedName("ads_applovin_native_id")
    @Expose
    private String adsApplovinNativeId = "";

    @SerializedName("ads_applovin_appopen_id")
    @Expose
    private String adsApplovinAppopenId = "";
    @SerializedName("ads_applovin_sdk_key")
    @Expose
    private String adsApplovinSdkKey = "";
    ...
    public String getAdsApplovinBannerId() {
        return adsApplovinBannerId;
    }

    public void setAdsApplovinBannerId(String adsApplovinBannerId) {
        this.adsApplovinBannerId = adsApplovinBannerId;
    }

    public String getAdsApplovinInterId() {
        return adsApplovinInterId;
    }

    public void setAdsApplovinInterId(String adsApplovinInterId) {
        this.adsApplovinInterId = adsApplovinInterId;
    }

    public String getAdsApplovinNativeId() {
        return adsApplovinNativeId;
    }

    public void setAdsApplovinNativeId(String adsApplovinNativeId) {
        this.adsApplovinNativeId = adsApplovinNativeId;
    }

    public String getAdsApplovinSdkKey() {
        return adsApplovinSdkKey;
    }

    public void setAdsApplovinSdkKey(String adsApplovinSdkKey) {
        this.adsApplovinSdkKey = adsApplovinSdkKey;
    }

    public String getAdsApplovinAppopenId() {
        return adsApplovinAppopenId;
    }

    public void setAdsApplovinAppopenId(String adsApplovinAppopenId) {
        this.adsApplovinAppopenId = adsApplovinAppopenId;
    }
}