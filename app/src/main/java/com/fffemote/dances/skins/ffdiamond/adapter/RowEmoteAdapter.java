...
public class RowEmoteAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RowEmoteAdapter(ArrayList<dress> contactsList, Context context, Activity mactivity) {
                ...
                public void onClick(View v) {
                    CTCAppLoadAds.getInstance().showInterstitial(mactivity, new CTCAppLoadAds.AdCompleteListener() {
                        ...
                        public void onAdCompleted() {
                            Intent intent = new Intent(mContext, EmoteVideoActivity.class);
