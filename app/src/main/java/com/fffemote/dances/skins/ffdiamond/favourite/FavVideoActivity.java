...
import com.fffemote.dances.skins.ffdiamond.Emotes.EmoteVideoActivity;
import com.fffemote.dances.skins.ffdiamond.R;
import com.fffemote.dances.skins.ffdiamond.adsp.CTCAppLoadAds;
import com.fffemote.dances.skins.ffdiamond.databinding.ActivityFavVideoBinding;
...
public class FavVideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actorRespository = new ActorRepository(getApplication());
        ...
        binding.favE.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AsyncTask.execute(new Runnable() {
                    @Override
                    public void run() {
                        actorViewModal.delete(vList);

                                Intent intent = new Intent(FavVideoActivity.this, FavoriteEmoteActivity.class);
